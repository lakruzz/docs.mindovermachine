...
[^cop]: Vi bruger begrebet "Community of Practice" som en problemorientret didaktisk disciplin og operationel betegnelse, først beskrevet af [_Lave & Wenger_](https://en.wikipedia.org/wiki/Community_of_practice). Det er ikke en formel medlemskabsorganisation, men snarere en abstraktion over det åbne og inkluderende fællesskab vi ønsker at skabe. som sikrer [_legitim perifær deltagelse](https://en.wikipedia.org/wiki/Legitimate_peripheral_participation)_, hvor alle; professionelle som _learners_ kan deltage på deres egne præmisser in en _mester|lærling_ relation, som tilbyder en klar vej til at blive mere involveret og tage mere ansvar i fællesskabet, hvis man ønsker det.
...
| **Mere end 10%, mindre end 40% | Variabel             | Lineær fordeling i intervallet.                  |
